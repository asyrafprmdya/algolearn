...
<div class="flex h-screen bg-slate-50 overflow-hidden">
    ...
    <main class="flex-1 flex flex-col overflow-hidden bg-slate-100" x-data="{
        questions: [{ id: 1, text: '', type: '{{ $category == "evaluation" ? "multiple_choice" : "arrange" }}', a: '', b: '', c: '', d: '', answer: 'a', options_arrange: '', correct_option_arrange: '', explanation: '' }],
        activeModalId: null,
        addQuestion() { this.questions.push({ id: Date.now(), text: '', type: '{{ $category == "evaluation" ? "multiple_choice" : "arrange" }}', a: '', b: '', c: '', d: '', answer: 'a', options_arrange: '', correct_option_arrange: '', explanation: '' }); },
